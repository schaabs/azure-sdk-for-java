...
public class DeletedKeyItem extends KeyItem {
    ...
    /**
     * Get the url of the recovery object, used to identify and recover the deleted key.
     *
    ...
    /**
     * Set the url of the recovery object, used to identify and recover the deleted key.
     *
    ...
    /**
     * Get the time when the key is scheduled to be purged, in UTC.
     *
    ...
    /**
     * Get the time when the key was deleted, in UTC.
     *
